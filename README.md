[![Run App ArnavKhandelwal](https://github.com/arrow9484/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/arrow9484/GithubActions/actions/workflows/run-app.yaml)
